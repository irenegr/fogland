...
function conky_main_box()
    ...
    local boxes_settings={
        --corners
        {x=15, y=10,w=130,h=350,
        colour={ {0,0x353535,0.8} },
        corners={ {"circle",6}, {"circle",0}, {"circle",6}, {"circle",6}}
       }, 
        --linear gradient
        {x=145, y=10,w=18,h=100,
        colour={ {0,0x000000,0.8}, {1,0x353535,0.7}},
        linear_gradient={0,150,0,0},
        corners={ {"circle",0}, {"circle",6}, {"line",18}, {"line",0},}, 
       },
        --line
        {x=145, y=10,w=1,h=99,
        colour={ {0,0x000000,0.5} },
        corners={ {"circle",0}, {"circle",0}, {"line",1}, {"line",0},}, 
       },
