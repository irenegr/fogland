...
config = {
    ...
    'links': OrderedDict([
        ('search', [
			['privatelee', 'https://www.google.com/'],
            ['google', 'https://www.google.com/'],
            ['duckduckgo', 'http://duckduckgo.com/'],
            ['startpage', 'https://startpage.com/'],
        ]),
        ('media', [
            ['dArt', 'http://www.deviantart.com/'],
            ['flickr', 'http://www.flickr.com/photos/irenegr/'],
            ['youtube', 'http://www.youtube.com/'],
        ]),
        ('fora', [
            ['fbook', 'https://www.facebook.com'],
            ['cbang', 'http://crunchbang.org/forums/'],
            ['wikipedia', 'http://en.wikipedia.org/wiki/Main_Page'],
            ['wallbase', 'http://wallbase.cc/home'],
            ['lBBQ', 'http://linuxbbq.org/bbs/index.php/']
        ])
    ])
}
